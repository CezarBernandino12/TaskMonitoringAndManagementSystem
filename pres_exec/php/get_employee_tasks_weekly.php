...
// ====================================================================
// FETCH TASKS (WEEKLY LOGIC)
// ====================================================================
//
// LOGIC:
// - Completed → only tasks completed within the selected week
// - Ongoing / Overdue → still included (active tasks)
//
// Same behavior as monthly, just different date range
// ====================================================================
$tasksSql = "
    SELECT
        t.id,
    ...
    WHERE t.assigned_to = ?
    AND (
        -- Completed within selected week
        (
