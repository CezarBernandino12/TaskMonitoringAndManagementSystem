                ...
                <div className="col-12 col-xl-4">
                    <div className="card p-3 h-100">
                        ...
                        <p className="text-muted mt-2 mb-0" style={{ fontSize: 12 }}>
                            Counts tasks whose deadline fell within each week and are
                            still incomplete. A decreasing trend means the team is
                            catching up.
                        </p>
                    </div>
                </div>
                ...
                <div className="col-12 col-xl-4">
                    <div className="card p-3 h-100">
                        ...
                        <p className="text-muted mb-3" style={{ fontSize: 12 }}>
                            Ranked by overdue rate (overdue ÷ total tasks). Rate is
                            fairer than raw count.
                        </p>
                    ...
                    <div className="d-flex flex-column gap-2">
                        {snapshots.map((snap) => {
                            const rate =
                                snap.data.total > 0
                                    ? Math.round(
                                          (snap.data.completed / snap.data.total) * 100
                                      )
                                    : 0;
                            ...
                            return (
                                ...
                                >
                                    <div style={{ flex: 1 }}>
                                        ...
                                        >
                                            <span>
                                                <strong>{snap.data.total}</strong> tasks
                                            </span>
                                            <span className="text-success">
                                                <strong>{snap.data.completed}</strong>{" "}
                                                completed
                                            </span>
                                            {snap.data.overdue > 0 && (
                                                <span className="text-danger">
                                                    <strong>{snap.data.overdue}</strong>{" "}
                                                    overdue
                                                </span>
                                            )}
                                        </div>
