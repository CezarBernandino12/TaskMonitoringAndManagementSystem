...
function AnnualReportPage() {
    ...
    // Chart canvas refs
    const groupedBarRef  = useRef(null); // department comparison
    const lineRef        = useRef(null); // monthly completion line (12 points — meaningful at annual scale)
    const quarterBarRef  = useRef(null); // quarterly stacked bar
    const donutRef       = useRef(null); // overall status donut
    const hBarRef        = useRef(null); // employee horizontal bar
    ...
    // Fetch annual report whenever year or department changes
    useEffect(() => {
    ...
    // 2. Monthly line — 12 months, ideal for showing year-long trajectory
    ...
    // 3. Quarterly stacked bar — quarter-by-quarter volume
    ...
    // 4. Donut — overall status breakdown
    ...
    useEffect(() => {
        ...
        // 2. LINE CHART — monthly completion trend across all 12 months
        // At annual scale, 12 data points make a meaningful line chart — shows
        // seasonal patterns, peak months, and year-long momentum clearly.
        ...
        lineChart.current = new Chart(lineRef.current, {
            ...
            options: {
                ...
                scales: {
                    x: {
                        title: { display: true, text: `${year} — Monthly Activity` },
                        grid: { display: false },
                    },
                    y: { beginAtZero: true, ticks: { stepSize: 1 } }
                }
        ...
        // 3. QUARTERLY STACKED BAR — quarter-by-quarter breakdown
        // Shows how each quarter contributed to the annual total.
        ...
        // 4. DONUT — overall annual task status breakdown
        ...
        // 5. HORIZONTAL BAR — employee performance for the year
    ...
    // Completion rate for summary cards
                ...
                <main>
                    ...
                    <div className="alert alert-info" role="alert" hidden>
                        ...
                        <ul className="mb-0 mt-1">
                            <li><strong>Completed</strong>: Tasks marked as completed within {year}.</li>
                        ...
                        view an employee's full task list for the year.
                    </div>
                            ...
                            <div className="card shadow-sm border-0 p-3">
                                <div className="d-flex justify-content-between align-items-center mb-3">
                                    <div>
                                        ...
                                        <small className="text-muted">Completed, Ongoing, and Overdue per department for {year}</small>
                                    </div>
                                    {selectedDept && (
                                        <div className="d-flex align-items-center gap-2">
                    ...
                    {/* Row 2: Monthly line chart (full width) — 12 points, the centrepiece annual visual */}
                    <div className="row mb-4">
                        <div className="col-12">
                            <div className="card shadow-sm border-0 p-3">
                    ...
                    {/* Row 3: Quarterly stacked bar + Donut side-by-side */}
                    <div className="row mb-4">
...
ReactDOM.createRoot(document.getElementById('root')).render(<AnnualReportPage />);
