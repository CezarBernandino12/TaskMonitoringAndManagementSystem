...
function getGreetingMeta(date = new Date()) {
    ...
    if (hour < 12) {
        return { label: "Good Morning", icon: "bi-sunrise-fill", chip: "Morning" };
    }
    if (hour < 18) {
        return { label: "Good Afternoon", icon: "bi-brightness-high-fill", chip: "Afternoon" };
    }
...
function UserChip({ user, userLoaded }) {
    ...
    const initials = user.initials || getInitials(user.name || "A");
        ...
        <div className="topbar-user-wrap" aria-label="Current user">
            ...
            >
                ...
                <div className="topbar-user-info" style={{ minWidth: 0 }}>
                    <div
                        className="text-body-secondary topbar-user-email"
                        style={{
                            fontSize: "12px",
                            lineHeight: 1.2,
                            whiteSpace: "nowrap",
...
function TopBar() {
    ...
    React.useEffect(() => {
        ...
        window.dispatchEvent(
            new CustomEvent("dashboard-theme-changed", { detail: { theme } })
        );
                ...
                <div className="d-flex align-items-center gap-3" style={{ minWidth: 0 }}>
                    ...
                    <div style={{ minWidth: 0 }}>
                        <div className="d-flex align-items-center flex-wrap gap-2 mb-1" style={{ minWidth: 0 }}>
                            ...
                            <span className="text-body-secondary" style={{ fontSize: "12px", fontWeight: 600 }}>
                                {todayText}
                            </span>
                        </div>
