...
-- CEZAR
ALTER TABLE `users` ADD `first_name` VARCHAR(255) NOT NULL AFTER `name`, ADD `last_name` VARCHAR(255) NOT NULL AFTER `first_name`, ADD `middle_initial` CHAR(1) NULL DEFAULT NULL AFTER `last_name`;